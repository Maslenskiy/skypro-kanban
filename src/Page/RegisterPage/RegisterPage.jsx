            ...
            <div className="modal">
				<div className="modal__block">
					...
					<form className="modal__form-login" id="formLogUp" action="#">
						...
						<button className="modal__btn-signup-ent _hover01" id="SignUpEnter"><Link to={patch.MAIN}>Зарегистрироваться</Link> </button>
						<div className="modal__form-group">
							<p>Уже есть аккаунт?  <Link to={patch.LOGIN}>Войдите здесь</Link></p>
						</div>
					</form>
				</div>
			</div>
